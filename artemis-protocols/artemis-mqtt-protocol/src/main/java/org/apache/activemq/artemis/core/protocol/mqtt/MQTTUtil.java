...
public class MQTTUtil {
   ...
   public static final int VARIABLE_BYTE_INT_MAX = 268_435_456;
   ...
   public static final int DEFAULT_MAXIMUM_PACKET_SIZE = VARIABLE_BYTE_INT_MAX;
   ...
   public static String convertCoreAddressFilterToMQTT(String filter, WildcardConfiguration wildcardConfiguration) {
      ...
      if (filter.startsWith(MQTT_RETAIN_ADDRESS_PREFIX)) {
         filter = filter.substring(MQTT_RETAIN_ADDRESS_PREFIX.length());
      }
