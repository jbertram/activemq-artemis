...
public class MQTTSessionState {
   ...
   private final MQTTSessionStateManager stateManager;
   ...
   public MQTTSessionState(String clientId, MQTTSessionStateManager stateManager) {
    ...
    */
   public MQTTSessionState(CoreMessage message, MQTTSessionStateManager stateManager) {
   ...
   public synchronized void clear() throws Exception {
      ...
      stateManager.storeSessionState(this);
   }
