...
See the general xref:protocols-interoperability.adoc[Protocols and Interoperability] chapter for details on configuring an `acceptor` for OpenWire.
...
Please see Virtual Topic Mapping example contained in the OpenWire xref:examples.adoc[examples].
