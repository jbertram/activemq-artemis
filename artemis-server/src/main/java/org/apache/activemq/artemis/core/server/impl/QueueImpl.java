...
public class QueueImpl extends CriticalComponentImpl implements Queue {
   ...
   * it's useful for usecases last LastValueQueue */
   ...
   private void move(final SimpleString toAddress,
      ...
      if (copyMessage.getAnnotationString(Message.HDR_ORIG_ROUTING_TYPE) != null) {
         copyMessage.setRoutingType(RoutingType.getType(copyMessage.getByteProperty(Message.HDR_ORIG_ROUTING_TYPE)));
      }
