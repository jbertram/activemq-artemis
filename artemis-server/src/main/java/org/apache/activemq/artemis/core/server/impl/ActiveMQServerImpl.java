...
public class ActiveMQServerImpl implements ActiveMQServer {
   ...
   @Override
   public BindingQueryResult bindingQuery(SimpleString address, boolean coreCompatible) throws Exception {
      if (address == null) {
      ...
      for (Binding binding : bindings.getBindings()) {
         if (binding.getType() == BindingType.LOCAL_QUEUE || binding.getType() == BindingType.REMOTE_QUEUE) {
            SimpleString name;
            if (coreCompatible && CompositeAddress.isFullyQualified(address.toString())) {
