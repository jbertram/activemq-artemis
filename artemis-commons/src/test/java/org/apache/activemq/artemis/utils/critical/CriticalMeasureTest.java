...
public class CriticalMeasureTest {
   ...
   public void testCriticalMeasure() throws Exception {
      ...
      Assertions.assertFalse(measure.checkExpiration(TimeUnit.SECONDS.toNanos(30), false));
   }
   ...
   public void testCriticalFailure() throws Exception {
      ...
      Assertions.assertTrue(measure.checkExpiration(TimeUnit.SECONDS.toNanos(30), false)); // on this call we should had a reset before
      // subsequent call without reset should still fail
      Assertions.assertTrue(measure.checkExpiration(TimeUnit.SECONDS.toNanos(30), true));
   ...
   public void testWithCloseable() throws Exception {
      ...
      try (AutoCloseable theMeasure = component.measureCritical(0)) {
         ...
         Assertions.assertTrue(component.checkExpiration(100, false));
      }
      Assertions.assertFalse(component.checkExpiration(100, false));
   }
